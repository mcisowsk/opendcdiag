...
struct CmdlineParser {
    ...
    int parse_args(SandstoneApplication* app, ParsedOpts& opts, char** argv)
    {
    ...
    int handle_restricted_command_line(int argc, char** argv, SandstoneApplication* app, ParsedOpts& opts) {
